...
export default {
  ...
  codexNotConnectedDesc: 'No Codex account connected yet. Click "Connect Codex" to sign in via your browser.',
  codexAccountLine: 'Account {account}',
  codexExpiresInDays: 'Credential expires in ~{days}d {hours}h',
  codexExpiresInHours: 'Credential expires in ~{hours}h',
  ...
  codexLoginDeviceFirstTime: 'First time: enable "Device code authentication for Codex" in ChatGPT Settings → Security.',
  ...
  codexModelsTitle: 'Available models',
  codexModelsRowTitle: 'Codex model list',
  codexModelsTotal: '{count} models',
  codexSourceOnline: 'Source: online',
  codexSourceCliCache: 'Source: local cache',
  codexSourceStale: 'Source: stale cache',
  codexSourceEmpty: 'No models yet',
  codexRefreshModels: 'Refresh model list',
  ...
  codexUsageTitle: 'Usage',
  codexUsagePlan: 'Plan: {plan}',
  codexUsagePrimaryWindow: '5-hour window',
  codexUsageSecondaryWindow: 'Weekly window',
  codexUsageResetIn: 'resets in ~{time}',
  codexUsageDaysHours: '{days}d {hours}h',
  codexUsageHoursMinutes: '{hours}h {minutes}m',
  codexUsageLoadFailed: 'Failed to load usage',
  codexResetsTitle: 'Reset credits',
  codexResetsCount: '{count} reset(s) available',
  codexResetsEarliestExpiry: 'Earliest expires {time}',
  ...
  codexResetStatusRedeemed: 'Used',
  codexResetStatusExpired: 'Expired',
  codexResetGrantedAt: 'Granted {time}',
  codexResetRedeemedAt: 'Used {time}',
  codexResetExpiresAt: 'Expires {time}',
